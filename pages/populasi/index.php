...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0 text-dark">Input Populasi Buah</h4>
        </div>
      </div>
      <div class="alert_pop"></div>
      <div class="row">
          ...
          <div class="card">
            <div class="card-header col-md-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="recipient-name" class="col-form-label">POPULASI BUAH:</label>
                          <input type="text" name="id_pop" id="id_pop" class="form-control">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="footer" align="center">
                ...
                <button type="button" class="pop_save_add btn btn-primary">INPUT</button>
              </div>
              </form>
            </div>
          </div>
...
?>
<script src="../../js/populasi.js"></script>
