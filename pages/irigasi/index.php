...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0 text-dark">Input Irigasi</h4>
        </div>
      </div>
      <div class="alert_irg"></div>
      <div class="row">
          ...
          <div class="card">
            <div class="card-header col-md-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="recipient-name" class="col-form-label">SUHU AIR:</label>
                          <input type="text" name="id_suhu" id="id_suhu" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="recipient-name" class="col-form-label">EC:</label>
                          <input type="text" name="id_ec" id="id_ec" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="recipient-name" class="col-form-label">PH:</label>
                          <input type="text" name="id_ph" id="id_ph" class="form-control">
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="recipient-name" class="col-form-label">VOLUME AIR:</label>
                          <input type="text" name="id_vol" id="id_vol" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="recipient-name" class="col-form-label">FREKUENSI:</label>
                          <input type="text" name="id_fre" id="id_fre" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label for="recipient-name" class="col-form-label">HUMIDITY MEDIA:</label>
                          <input type="text" name="id_hum" id="id_hum" class="form-control">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="footer" align="center">
                ...
                <button type="button" class="irg_save_add btn btn-primary">INPUT</button>
              </div>
              </form>
            </div>
          </div>
...
?>
<script src="../../js/irigasi.js"></script>
